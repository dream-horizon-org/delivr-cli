    ...
    return Q(null).then(() => {
        ...
        switch (command.type) {
            ...
            case cli.CommandType.createPatch:
                return createPatch(command);
            case cli.CommandType.applyPatch:
                return applyPatch(command);
            default:
...
function createPatch(command) {
    return Q.Promise((resolve, reject) => {
        ...
        (0, exports.log)("==Input Arguments==");
        (0, exports.log)(`Old bundle: ${command.oldBundle}`);
        (0, exports.log)(`New bundle: ${command.newBundle}`);
        (0, exports.log)(`Patch directory: ${patchDir}`);
        ...
        child.on("close", (code) => {
            if (code === 0) {
                (0, exports.log)("Patch file created successfully!");
                resolve();
            }
            else {
...
function applyPatch(command) {
    return Q.Promise((resolve, reject) => {
        ...
        (0, exports.log)(`Applying patch to ${command.oldBundle}`);
        (0, exports.log)(`Output will be saved to: ${command.outputBundle}`);
        const child = childProcess.spawn("bash", [scriptPath, ...args], {
            stdio: "inherit",
            cwd: process.cwd()
        });
        child.on("close", (code) => {
            if (code === 0) {
                (0, exports.log)("Patch applied successfully!");
                resolve();
            }
            else {
